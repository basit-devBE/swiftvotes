        ...
        <div className="relative overflow-hidden rounded-[2.25rem] bg-ink px-6 py-12 text-white shadow-card sm:px-8 lg:px-12 lg:py-14">
          ...
          <div className="relative flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              <p className="section-kicker text-white/60">For organisers</p>
              <h2 className="mt-4 font-display text-5xl font-semibold leading-none tracking-[-0.04em] text-balance sm:text-6xl">
                Prepare your next awards campaign before voting opens.
              </h2>
              <p className="mt-5 max-w-2xl text-lg leading-8 text-white/72">
                Set up categories, pricing, media, nominations, and voting dates now,
                then submit the event for platform review when it is ready.
              </p>
            </div>
