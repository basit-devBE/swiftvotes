...
import { TicketCallbackView } from "@/components/tickets/ticket-callback-view";

export const metadata = { title: "Confirming your tickets" };
    ...
    <div className="relative min-h-screen overflow-x-clip">
      ...
      <main className="page-shell pb-16 pt-10 sm:pb-20 sm:pt-14">
        <Suspense
          fallback={
            <AppLoadingState
              label="Loading ticket payment"
              detail="Preparing ticket confirmation."
            />
          }
        >
          <TicketCallbackView />
